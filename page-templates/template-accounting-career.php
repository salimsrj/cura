<?php
/**
 * Template Name: Accounting Career
 *
...
<section class="inner-banner style-6"
    style="background: url(<?php echo get_stylesheet_directory_uri();?>/images/banner5-bg.jpg); background-size: cover; background-position: center center;">
    <div class="container">
        <div class="row">
            <div class="col-12">
