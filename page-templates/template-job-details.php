            ...
            <div class="col-12">
                <div class="job-content-box">
                    <div class="job-content">
                        <span class="sub-title">Sharepoint, Inc.</span>
                        <h2 class="title">Security tech writer</h2>
                        <div class="details">
                            <p><strong>Details</strong></p>
                            <ul>
                                <li><span class="icon"><img src="<?php echo get_stylesheet_directory_uri();?>/images/Icon-bag.png" alt="icon"></span>Physical</li>
                                <li><span class="icon"><img src="<?php echo get_stylesheet_directory_uri();?>/images/Icon-payment.png" alt="icon"></span>Permanent Position</li>
                                <li><span class="icon"><img src="<?php echo get_stylesheet_directory_uri();?>/images/Icon-calendar.png" alt="icon"></span>Posted on July 12, 2022</li>
                            </ul>
                        </div>
                        <br>
